...
# is in the manual.
COMMENT_SYSTEM_ID = "biomathgithub"
...
MathJax.Hub.Config({
    ...
    displayAlign: 'center', // Change this to 'left' to left-align equations.
    "HTML-CSS": {
...
SOCIAL_BUTTONS_CODE = """
<!-- Social buttons -->
<div id="addthisbox" class="addthis_toolbox addthis_peekaboo_style addthis_default_style addthis_label_style addthis_16x16_style">
...
<script>
  ...
  ga('create', 'UA-48277502-1', 'mathbio.github.io');
  ga('send', 'pageview');
